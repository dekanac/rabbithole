...
[[vk::binding(1)]] Texture2D<float>             t2d_DepthBuffer  : register(t0);
[[vk::binding(2)]] Texture2D<float4>            t2d_NormalBuffer : register(t1);
[[vk::binding(3)]] StructuredBuffer<uint>       sb_tileMetaData : register(t2);
