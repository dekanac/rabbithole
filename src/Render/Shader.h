...
{
  public:
    friend class ResourceManager; // Resource Manager will take care of creation
                                  // and deletion of shaders

    Shader(VulkanDevice& device, size_t byteCodeSize, const char* byteCode, const ShaderInfo& info,
           const char* name);
    ~Shader();
  ...
  public:
    ...
    inline const std::vector<VkDescriptorSetLayoutBinding>& GetDescriptorSetLayoutBindings() const
    {
