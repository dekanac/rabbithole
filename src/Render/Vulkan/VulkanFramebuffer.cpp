...
VulkanFramebuffer::VulkanFramebuffer(const VulkanDevice* device, const VulkanFramebufferInfo& info,
    ...
    : m_VulkanDevice(device), m_Info(info)
{
    ...
    VULKAN_API_CALL(vkCreateFramebuffer(m_VulkanDevice->GetGraphicDevice(), &framebufferInfo,
