...
{
  public:
    VulkanImage(const VulkanDevice* device, const VulkanImageInfo& info, const char* name);
    ~VulkanImage();
...
{
  public:
    VulkanImageView(const VulkanDevice* device, const VulkanImageViewInfo& info, const char* name);
    ~VulkanImageView();
...
{
  public:
    VulkanImageSampler(const VulkanDevice* device, const VulkanImageSamplerInfo& info,
                       const char* name);
    ~VulkanImageSampler();
