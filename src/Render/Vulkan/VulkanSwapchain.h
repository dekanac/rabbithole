...
class VulkanSwapchain
{
  public:
    ...
    uint32_t const GetImageCount() const
    {
        return static_cast<uint32_t>(m_SwapChainVulkanImages.size());
    }
    ...
    VulkanImage* GetSwapChainImage(uint32_t imageIndex) const
    {
        return m_SwapChainVulkanImages[imageIndex];
    }
