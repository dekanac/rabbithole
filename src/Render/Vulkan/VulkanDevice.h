...
class VulkanDevice
{
  ...
  public:
    ...
    void CopyBuffer(VulkanCommandBuffer& commandBuffer, VulkanBuffer& srcBuffer,
                    VulkanBuffer& dstBuffer, uint64_t size, uint64_t srcOffset = 0,
                    uint64_t dstOffset = 0);
    void CopyBufferToImage(VulkanCommandBuffer& commandBuffer, VulkanBuffer* buffer,
                           VulkanTexture* texture, uint32_t mipCount = 1);
    void CopyBufferToImageCubeMap(VulkanCommandBuffer& commandBuffer, VulkanBuffer* buffer,
                                  VulkanTexture* texture);
    void CopyImageToBuffer(VulkanCommandBuffer& commandBuffer, VulkanTexture* texture,
                           VulkanBuffer* buffer);
    ...
    void ResourceBarrier(VulkanCommandBuffer& commandBuffer, VulkanBuffer* buffer,
                         ResourceState oldLayout, ResourceState newLayout, ResourceStage srcStage,
