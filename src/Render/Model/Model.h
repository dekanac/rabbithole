...
class VulkanglTFModel
{
  public:
    ...
    VulkanglTFModel(Renderer* renderer, std::string filename, RenderingContext context,
  ...
  public:
    ...
    struct Material
    {
        ...
        // TODO: split descriptors into 3 levels PER_OBJECT, PER_PASS and
        // PER_FRAME, then you should get rid of this
  ...
  private:
    void LoadNode(const aiNode* inputNode, const aiScene* input, VulkanglTFModel::Node* parent,
  ...
  public:
    void DrawNode(VulkanCommandBuffer& commandBuffer, const VulkanPipelineLayout* pipelineLayout,
                  VulkanglTFModel::Node node, uint8_t backBufferIndex,
                  IndexedIndirectBuffer* indirectBuffer);
    void Draw(VulkanCommandBuffer& commandBuffer, const VulkanPipelineLayout* pipeLayout,
              uint8_t backBufferIndex, IndexedIndirectBuffer* indirectBuffer);
