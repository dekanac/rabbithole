...
{
  public:
    ManagableResource(ResourceType type) : m_Type(type) {}
    ...
    void SetCurrentResourceStage(ResourceStage stage)
    {
        m_PreviousResourceStage = m_CurrentResourceStage;
        m_CurrentResourceStage = stage;
    }
