...
template <> struct std::hash<GraphicsPipelineKey>
{
...
template <> struct std::hash<ComputePipelineKey>
{
...
template <> struct std::hash<RayTracingPipelineKey>
{
...
class PipelineManager
{
  ...
  public:
    ...
    VulkanPipeline* FindOrCreateRayTracingPipeline(VulkanDevice& device,
                                                   PipelineInfo& pipelineInfo);
    RenderPass* FindOrCreateRenderPass(VulkanDevice& device,
                                       const std::vector<VulkanImageView*>& renderTargets,
                                       const VulkanImageView* depthStencil,
                                       RenderPassInfo& renderPassInfo);
    VulkanDescriptorSet*
    FindOrCreateDescriptorSet(VulkanDevice& device, const VulkanDescriptorPool* desciptorPool,
