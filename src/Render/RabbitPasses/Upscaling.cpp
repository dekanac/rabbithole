...
void FSR2Pass::Setup()
{
    m_Renderer.ResourceBarrier(FSR2Pass::Output, ResourceState::GenericRead,
                               ResourceState::GeneralComputeReadWrite, ResourceStage::Graphics,
                               ResourceStage::Compute);
    m_Renderer.ResourceBarrier(ApplyVolumetricFogPass::Output, ResourceState::RenderTarget,
...
void FSR2Pass::Render()
{
    ...
    SuperResolutionManager::instance().Draw(m_Renderer.GetCurrentCommandBuffer(), fsrSetup,
                                            &m_Renderer.GetUIState());

    m_Renderer.ResourceBarrier(FSR2Pass::Output, ResourceState::GeneralComputeReadWrite,
                               ResourceState::GenericRead, ResourceStage::Compute,
                               ResourceStage::Compute);
}
