...
class ResourceManager
{
  ...
  public:
    VulkanTexture* CreateSingleMipFromTexture(VulkanDevice& device, const VulkanTexture* texture,
                                              uint32_t mipSlice);
    VulkanTexture* CreateTexture(VulkanDevice& device, const TextureData* data,
                                 ROTextureCreateInfo createInfo);
    VulkanTexture* CreateTexture(VulkanDevice& device, std::string path,
                                 ROTextureCreateInfo createInfo);
    ...
    bool CreateShader(VulkanDevice& device, ShaderInfo& createInfo, const char* code,
