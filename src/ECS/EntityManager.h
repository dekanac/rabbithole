...
class EntityManager
{
  ...
  public:
    ...
    template <typename TComponent> auto GetAllEntitiesWithComponent()
    {
    ...
    template <typename... TComponent> auto GetAllEntitiesWithComponents()
    {
        std::vector<Entity*> returnVec{};
    ...
    template <typename TComponent> auto GetAllComponentInstances()
    {
